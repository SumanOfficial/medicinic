...
function medicinic_sidebar()
{
    ...
    $hero_args = array(
        ...
        'before_widget' => '<div class="col-lg-12 text-center">',
        'after_widget' => '</div>',
     ...
     */
    $hero_args = array(
        'name' => __('Testimonials Hero Sidebar', 'medicinic'),
        'id' => 'testimonial-hero-sidebar',
        'description' => __('This is the landing page Doctors sidebar for hero text area !', 'medicinic'),
        'before_widget' => '<div class="testimonial-heading">',
        'after_widget' => '</div>',
        'before_title'  => '<h6>',
        'after_title'   => '</h6>',
        'before_sub_title'  => '<h1>',
